...
<c:if test="${!empty userinfo }"> <a id="MemberMenuChange" href="MemberCenter_showmenber.action" target="_self">会员中心</a></c:if>
    ...
    ${userinfo.uName } 
      ...
      </a>|<a  onclick="document.getElementById('zhuxiaoform').submit();"  id="b-regist">注销</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tel.png"/>			
      ...
      <tr><td>            
        <input type="hidden" name="tname"  value="${tname}">
             ...
             <input type="hidden" name="url" value="forward:/Trends_showTeia.action?tr_id=${_trends.trId  }">
      </td></tr>
      </table>
      </form>
