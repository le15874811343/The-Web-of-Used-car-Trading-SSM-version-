...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="/S4SSMManager/Trends_showcom.action">留言</a></li>
...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改评论</h2>
		<div class="manage">
			<form action="/S4SSMManager/Trends_tjupcom.action" method="post" onsubmit="return cheksub('maxAge','chekAge','zm','chekZm')">
				...
				<tr><td>评论头图片</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><img src="/S4SSMManager/${ucomment.cImg }" /></div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
