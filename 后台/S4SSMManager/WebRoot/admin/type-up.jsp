...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改车型</h2>
		<div class="manage">
			<form action="/S4SSMManager/Model_tjuptype.action" method="post" onsubmit="return chekSub()">
				...
				<tr><td>车型Logo</td><td ><div align="center" style="height:200;border:5px solid red; " id="fa1"><img src="/S4SSMManager/${upcartype.tClass }"/></div><div style=" height:0px; overflow:hidden; position:absolute;" ><input type="file" id="filePath" name="filePath" onchange="fileupload('filePath','fa1','ttp')"/></div>
