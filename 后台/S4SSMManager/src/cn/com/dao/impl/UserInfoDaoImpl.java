...
public class UserInfoDaoImpl extends BaseDao implements IUserInfoDao, IPageDao {
   ...
   userMap=super.getSqlSessionTemplate().selectMap("cn.com.pojo.Userinfo3Mapper.showPersonCarList", parmas,"uId");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public int deleteuserinfouser(Userinfo3 u) {
		// TODO Auto-generated method stub
		return super.getSqlSessionTemplate().delete("cn.com.pojo.Userinfo3Mapper.deleteuserinfouser", u);
	}
